...
// Helper to read .env manually because dotenv might be flaky with ESM sometimes or path issues
// But let's trust standard process first.
dotenv.config();
