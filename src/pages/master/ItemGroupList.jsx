...
function ItemGroupList() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const url = editingItem ? `/api/item-groups/${editingItem.id}` : '/api/item-groups';
    ...
    return (
        <div>
            <div className="page-header">
                <h1 className="page-title">Master Item Group</h1>
                <button className="btn btn-primary" onClick={() => { setShowForm(true); setEditingItem(null); resetForm(); }}>+ Tambah Group</button>
            </div>
                ...
                <div className="modal-overlay">
                    <div className="modal" style={{ maxWidth: '500px' }}>
                        <div className="modal-header">
                            <h3>{editingItem ? 'Edit Item Group' : 'Tambah Item Group Baru'}</h3>
