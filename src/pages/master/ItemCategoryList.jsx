...
function ItemCategoryList() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const url = editingItem ? `/api/item-categories/${editingItem.id}` : '/api/item-categories';
    ...
    return (
        <div>
            <div className="page-header">
                <h1 className="page-title">Master Item Category</h1>
                <button className="btn btn-primary" onClick={() => { setShowForm(true); setEditingItem(null); resetForm(); }}>+ Tambah Category</button>
            </div>
                ...
                <div className="modal-overlay">
                    <div className="modal" style={{ maxWidth: '500px' }}>
                        <div className="modal-header">
                            <h3>{editingItem ? 'Edit Item Category' : 'Tambah Item Category Baru'}</h3>
