...
function APAgingReport() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('/api/reports/ap-aging');
    ...
    return (
        <div className="report-page">
            <div className="page-header">
                <div>
                    <h1 className="page-title">Laporan AP Aging (Umur Hutang)</h1>
                    <p className="text-subtitle">Analisis umur hutang berdasarkan jatuh tempo</p>
                </div>
                <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    >
                        ...
                        <option value="summary">Summary per Supplier</option>
                    </select>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '1rem', marginBottom: '1rem' }}>
                ...
                <div className="card" style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#1976d2', color: 'white' }}>
                    <div style={{ fontSize: '0.8rem' }}>Total Hutang</div>
