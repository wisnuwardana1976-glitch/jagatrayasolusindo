...
function AROutstandingReport() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('/api/reports/ar-outstanding');
    ...
    return (
        <div className="report-page">
            <div className="page-header">
                <div>
                    <h1 className="page-title">Laporan AR Outstanding (Piutang)</h1>
                    <p className="text-subtitle">Daftar AR Invoice (Piutang) yang belum dibayar Customer</p>
                </div>
                                ...
                                {filteredData.length === 0 ? (
                                    <tr>
                                        <td colSpan="7" style={{ textAlign: 'center', padding: '2rem' }}>
                                            Tidak ada AR Invoice yang outstanding
                                        </td>
                                    </tr>
                                ) : (
                            ...
                            {filteredData.length > 0 && (
                                <tfoot>
                                    <tr style={{ fontWeight: 'bold', backgroundColor: '#f5f5f5' }}>
                                        <td colSpan="4" style={{ textAlign: 'right' }}>Total Piutang Outstanding:</td>
...
export default AROutstandingReport;
