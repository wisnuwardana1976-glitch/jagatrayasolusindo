                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="form-row">
                                <div className="form-group">
                                    ...
                                    <select
                                        ...
                                        required
                                        disabled={editingItem} // Usually can't change type on edit
                                    >
                            ...
                            <div className="form-section">
                                <div className="form-section-header">
                                    <h4>Daftar Barang</h4>
                                    <button type="button" className="btn btn-outline" onClick={handleAddItem} disabled={sourceType === 'so' && !formData.so_id}>+ Tambah Manual</button>
                                </div>
                                        ...
                                        {formData.items.length === 0 ? (
                                            ...
                                            formData.items.map((item, idx) => (
                                                <tr key={idx}>
                                                    ...
                                                    <td>
                                                        <button type="button" className="btn-icon" onClick={() => handleRemoveItem(idx)}>🗑️</button>
                                                    </td>
                                                </tr>
                                            ))
                                        )}
